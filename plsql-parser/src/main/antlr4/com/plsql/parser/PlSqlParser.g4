...
collection_method_call // collection methods invocation that could be used as a statement
    : general_element '.' (
        ...
        | (COUNT | EXISTS | FIRST | LAST | NEXT | PRIOR | LIMIT) ('(' (index += expression)? ')')?
    )
    ;
...
flashback_query_clause
    : VERSIONS (PERIOD_KEYWORD FOR column_name BETWEEN | BETWEEN (SCN | TIMESTAMP)) (MINVALUE | concatenation) AND (MAXVALUE | concatenation)
...
dml_table_expression_clause
    ...
    | tableview_name function_argument
